...
func (m *mocker) Package(info *compile.PackageInfo, pkg *ast.Package) bool {
	return pkg.Name != mainPkg
}

func (m *mocker) FilePre(info *compile.FileInfo, file *ast.File) bool {
...
func (m *mocker) FilePost(info *compile.FileInfo, file *ast.File) error {
...
func (m *mocker) Import(info *compile.FileInfo, spec *ast.ImportSpec) {
	m.imports = append(m.imports, spec)
}

func (m *mocker) Interface(info *compile.TypeInfo, node *ast.InterfaceType) {
	decls := []ast.Decl{}
